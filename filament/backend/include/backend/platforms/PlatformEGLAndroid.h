...
protected:
    ...
    TextureFormat mapToFilamentFormat(unsigned int hardwareBufferFormat, bool isSrgbTransfer) noexcept;
    TextureUsage mapToFilamentUsage(unsigned int hardwareBufferUsage, TextureFormat format) noexcept;
